...
echo -e "Installing gcc-4.8 backport, clang, llvm, vim, git, make, and firefox"
...
sudo update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-4.8 100 &> /dev/null
sudo update-alternatives --install /usr/bin/g++ g++ /usr/bin/g++-4.8 100 &> /dev/null
